...
Description: This program simulates the operations of a vending machine. Below, I wrote four different & simple
...
# Menu is being displayed from a dictionnary
...
#display_menu() takes one parameter and output it to the screen/user
...
#Function to accepts and counts cash inserted
def take_cash():
...
#gt_change() function remits/dispenses left-over changes if any
